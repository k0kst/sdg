...
// "Possible Areas of Exploration" — CCAs and subjects offered in
// Singapore secondary schools, the primary equivalent of the
// courses and subjects shown to older students — so it is
// relabelled and filled per goal rather than hidden. Goal names are listed per
...
(function () {
  ...
  C.modes.overrides.primary = {
    ui: {
      ...
      sectionLabels:   { studyPathways: "Possible Areas of Exploration" },
    ...
    sdgs: {
      1:  { name: "No Poverty",
            ...
            studyPathways: ["Social Studies", "Uniformed Groups", "Entrepreneurship Club"] },
      2:  { name: "Zero Hunger",
            ...
            studyPathways: ["Nutrition and Food Science", "Biology", "Environmental Club"] },
      3:  { name: "Good Health and Well-Being",
            ...
            studyPathways: ["Biology", "Sports CCAs", "Nutrition and Food Science"] },
      4:  { name: "Quality Education",
            ...
            studyPathways: ["Literature in English", "Mother Tongue Languages", "Drama Club"] },
      5:  { name: "Gender Equality",
            ...
            studyPathways: ["Social Studies", "History", "Debate Club"] },
      6:  { name: "Clean Water and Sanitation",
            ...
            studyPathways: ["Chemistry", "Geography", "Environmental Club"] },
      7:  { name: "Affordable and Clean Energy",
            ...
            studyPathways: ["Physics", "Design and Technology", "Robotics Club"] },
      8:  { name: "Decent Work and Economic Growth",
            ...
            studyPathways: ["Principles of Accounts", "Mathematics", "Entrepreneurship Club"] },
      9:  { name: "Industry, Innovation and Infrastructure",
            ...
            studyPathways: ["Design and Technology", "Computing", "Robotics Club"] },
      10: { name: "Reduced Inequalities",
            ...
            studyPathways: ["Social Studies", "History", "Uniformed Groups"] },
      11: { name: "Sustainable Cities and Communities",
            ...
            studyPathways: ["Geography", "Design and Technology", "Environmental Club"] },
      12: { name: "Responsible Consumption and Production",
            ...
            studyPathways: ["Science", "Geography", "Art"] },
      13: { name: "Climate Action",
            ...
            studyPathways: ["Geography", "Science", "Environmental Club"] },
      14: { name: "Life Below Water",
            ...
            studyPathways: ["Biology", "Geography", "Environmental Club"] },
      ...
      17: { name: "Partnerships for the Goals",
            ...
            studyPathways: ["Social Studies", "Mother Tongue Languages", "Performing Arts"] }
    },
    purposes: {
